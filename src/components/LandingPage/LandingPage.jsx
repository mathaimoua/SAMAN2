  ...
  return (
    <div className="md:flex">
      <div className="flex-column md:h-screen h-[50%] md:w-[50%] bg-zinc-300 text-black md:pt-[70px]">
        ...
        <img
            src={samanPic}
            className="pt-[40px] md:pt-0 relative top-[0%] ml-auto mr-auto z-0"
          />
          <p className='relative top-0 z-10'>Simple Asset Management (SAMAN) is exactly what the name suggests,
      ...
      <div className="md:w-[50%] md:mt-[20%] mt-[10%] ">
        <LoginForm />
      </div>
    </div>
  );
